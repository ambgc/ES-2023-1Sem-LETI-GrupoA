...
/**
 * A interface {@code ColumnGetter} fornece metodos para obter colunas a partir
 * de uma String. As classes que implementam esta interface devem definir o
 * comportamento do método {@link #getColumn()}. Além disso, uma implementação
 * padrão é fornecida para obter colunas a partir de um String de entrada.
 *
 * <p>
...
public interface ColumnGetter {
	...
	/**
	 * obtem uma matriz de colunas a partir do texto de entrada especificado.
	 * Espera-se que o texto de entrada esteja formatado usando o caractere '|' como
	 * delimitador.
	 *
